...
$app->get('/courses/{courses}/students', 'CourseStudentsController@index');
$app->post('/courses/{courses}/students/{students}', 'CourseStudentsController@store');
$app->delete('/courses/{courses}/students/{students}', 'CourseStudentsController@destroy');
